...
train_dataset = TrustDataset("all_combined_prepared_with_demographics.xlsx", split="train")
valid_dataset = TrustDataset("all_combined_prepared_with_demographics.xlsx", split="valid")
...
### SAVE WEIGHTS
torch.save(model.state_dict(), f"test_f1_{np.mean(test_measures[2]):0.5f}.pt")